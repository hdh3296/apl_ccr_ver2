...
#define     DIVIDE_10		1 // 소수점 자리 수 2자리 까지 표기 
#define     DIVIDE_100		2
...
unsigned long   EditDigitMaxValue; // 최대 표시 값 
unsigned long   EditDigitMinValue; // 최소 표시 값 

unsigned int   EditDigitCursor;
unsigned int   EditDigitShiftCnt;
unsigned int   EditCursor;
unsigned int   EditStatus;
unsigned int   EditStart; // LCD상의 표시 위치 
unsigned int   EditShiftCnt; // 자릿수 
unsigned int   EditDivide; // 소수점 자리 수 저장 변수 
unsigned int   EditDataType;
unsigned int   EditFlashAddr; // Flash Block 영역 주소 저장 변수 
...
//////////////////////////////////////////////////////////
        ...
        case    DRIVE_METHOD:
            ...
            if(DigitData==1)		DigitData=0x55;  //짝수
            else if(DigitData==2)	DigitData=0xaa;	 //홀수	
            else if(DigitData==0)	DigitData=0xff;  //전층 
...
void  Group1(void)
{
    ...
    switch(LadderGroupSub){
        case    GROUP1_MENU01:	// 버전 
            ...
            EditFlashAddr=BLOCK_VERSION; 
			ReadByteData(EditFlashAddr);
            Integer_Digit();
			break;
		case	GROUP1_MENU02:	// Duty Cnt
            EditCursor=0;
            EditStatus=DIGIT_EDIT;
            EditStart=3;
            EditShiftCnt=3;
            ...
            EditFlashAddr=BLOCK_DUTY_CNT;
			ReadByteData(EditFlashAddr);
            Integer_Digit();
			break;
		case	GROUP1_MENU03: // Duty Rate
            EditCursor=0;
            EditStatus=DIGIT_EDIT;
            EditStart=3;
            EditShiftCnt=3;
            EditDivide=DIVIDE_1;				
            EditDigitMaxValue=100;
            EditDigitMinValue=0;
			if(EditDivide > 0)	EditShiftCnt=(EditShiftCnt+1);	
		...
		case	GROUP1_MENU07: // 야간 셋팅 값 
            ...
            Integer_Digit();
			break;						
		case	GROUP1_MENU08: // MaxSetADay 낮 최대 값 
            EditCursor=0;
            EditStatus=DIGIT_EDIT;
            EditStart=3;
            EditShiftCnt=5;
            ...
            Integer_Digit();
			break;			
		case	GROUP1_MENU09: // MaxSetAEve 저녁 최대 값 
            EditCursor=0;
            EditStatus=DIGIT_EDIT;
            EditStart=3;
            EditShiftCnt=5;
            ...
            Integer_Digit();
			break;			
		case	GROUP1_MENU10: // MaxSetANig 밤 최대 값 
            EditCursor=0;
            EditStatus=DIGIT_EDIT;
            EditStart=3;
            EditShiftCnt=5;
...
void  Group2(void)
{
    ...
    switch(LadderGroupSub){
		case	GROUP2_MENU01: // Set DutyCycle 낮 변수 저장 값 
            EditCursor=0;
            EditStatus=NO_EDIT;
            EditStart=3;
            EditShiftCnt=4;
            ...
            Integer_Digit();
			break;			
		case	GROUP2_MENU02: // Set DutyCycle 저녁 변수 저장 값 
            EditCursor=0;
            EditStatus=NO_EDIT;
            EditStart=3;
            EditShiftCnt=4;
            ...
            Integer_Digit();
			break;				
		case	GROUP2_MENU03: // Set DutyCycle 밤 변수 저장 값 
            EditCursor=0;
            EditStatus=NO_EDIT;
            EditStart=3;
            EditShiftCnt=4;
